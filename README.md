...
| `/reset` | Reset internal state (loop detector and web search) without clearing the KV-cache. Useful for recovering from a disabled web search after an interrupt or connection failure |
