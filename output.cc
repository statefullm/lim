...
static string html_escape(const string& input) {
  ...
  { string sentinel_gt(1, Tokens::HTML_SENTINEL_CHAR); sentinel_gt += "gt"; sentinel_gt += Tokens::HTML_SENTINEL_CHAR; escape_tag(result, sentinel_gt, Tokens::HTML_ESCAPE_CHAR); }
