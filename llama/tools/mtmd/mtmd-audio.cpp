...
// Template parameters:
//   Inverse: false = DFT with exp(-2pikn/N), no scaling
//            true  = IDFT with exp(+2pikn/N), scales by 1/N
...
// Template parameters:
//   Inverse: false = FFT with exp(-2pik/N), no scaling
//            true  = IFFT with exp(+2pik/N), scales by 0.5 at each level
